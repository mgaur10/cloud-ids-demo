...
output "_3_ids_iap_ssh_attacker_server" {
  value = "gcloud compute ssh --zone ${var.network_zone} ${google_compute_instance.ids_attacker_machine.name}  --tunnel-through-iap --project ${google_project.ids_project.project_id}"
 }
